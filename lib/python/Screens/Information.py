...
class ImageInformation(InformationBase):
	...
	def displayInformation(self):
		...
		if isPluginInstalled("Servicelibpl") and not isPluginInstalled("ServiceMP3"):
			mediaService = "Servicelibpl"
		elif isPluginInstalled("ServiceMP3") and not isPluginInstalled("Servicelibpl"):
...
class ReceiverInformation(InformationBase):
	...
	def displayInformation(self):
		...
		if isfile("/proc/stb/info/stb_id"):
