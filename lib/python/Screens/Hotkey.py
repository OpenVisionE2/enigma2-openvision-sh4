...
def getHotkeyFunctions():
	...
	hotkey.functions.append((_("Latest Commits"), "Module/Screens.Information/CommitLogInformation", "Setup"))
	...
	hotkey.functions.append((_("Locale/Language"), "Module/Screens.LocaleSelection/LocaleSelection", "Setup"))
